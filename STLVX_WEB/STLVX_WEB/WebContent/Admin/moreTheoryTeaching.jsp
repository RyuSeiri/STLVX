...
req.open("post", "<%=basePath%>Article.do?method=moreTheoryTeaching");
	...
	if (req.readyState == 4 && req.status == 200) {
	 //alert(req.responseText);
		...
		for(var i=0;i<result.length;i++){
			  var contents =  "<li><span>"+result[i].dMakeTime+"</span><a href='<%=basePath%>Article.do?method=selectActicleByid&articleid="+result[i].sArticleId+"'>"+result[i].sTitle+"</a></li>";
...
$(document).ready(function(){
    ...
    <div style="width:1000px;position: relative;margin: 47px auto 0px;box-shadow:1px 1px 7px #999;">
        ...
        <div id="local" class="yc_location">当前位置：<a href="${pageContext.request.contextPath}/Admin/index.jsp">首页</a> &gt; <a href="${pageContext.request.contextPath}/Admin/TheoryTeaching.jsp">理论教学</a> &gt; <a href="#">更多理论教学</a></div>
              <div class="yc_right_box fl">
                    <div id="2jtitle" class="yc_right_title0"><span style="float:left;">更多理论教学</span> 
