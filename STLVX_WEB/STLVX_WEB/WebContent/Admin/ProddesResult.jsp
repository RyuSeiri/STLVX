...
req.open("post", "<%=basePath%>Article.do?method=selectActicleByKind&kind=13");
...
$(document).ready(function(){
    ...
    <div style="width:1000px;position: relative;margin: 47px auto 0px;box-shadow:1px 1px 7px #999;">
        ...
        <div id="local" class="yc_location">当前位置：<a href="${pageContext.request.contextPath}/Admin/index.jsp">首页>首页</a> &gt; <a href="#">教育</a> &gt; <a href="#">环境教育效果</a></div>
