...
<body style="background:url(/STLVX_WEB/images/bg_sea.jpg) no-repeat center top" >
	...
	<header class="yc_header">
 	...
 	<div class="navbg"> 
		<div class="nave">
			<h3><a href="${userName!=null?'/STLVX_WEB/Admin/index.jsp':'/STLVX_WEB/jsp/index.jsp'}">首页</a>|<a href="AboutUS.jsp" >关于本站</a>|<a href="UsingHelp.jsp" >使用帮助</a>|<a href="LinkUS.jsp" class="fcous">联系我们</a>|<a href="">网站声明</a></h3>
		</div>
    </div>
	<div style="width:1000px;position: relative; margin: 47px auto 0px; box-shadow: 1px 1px 7px #999;">
		...
		<div style="margin: 65px 0 0 0px">
			  <strong><span style="font-size:14px;"><span style="font-size:18px;">联系电话：13022479530</span><span style="font-size:16px;"></span></span></strong>
		</div>
		<!--yc_content_inner-->
		...
		<footer class="yc_footer">
			<div class="yc_flinks">
			<a href="AboutUS.jsp">关于本站</a>|
				<a href="UsingHelp.jsp">使用帮助</a> |
				<a	href="javascript:popup('<div>联系电话：13022479530</div>')">联系我们</a> | 
			...
			<div class="yc_copyright">
				Copyright&copy;20016-2016 All Rights Reserved<br> 主办：沈阳农业大学
			</div>
		</footer>
	</div>
