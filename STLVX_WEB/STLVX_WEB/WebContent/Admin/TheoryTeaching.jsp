	  ...
	  //alert(req.responseText);
		...
		for(var i=0;i<result.length;i++){
			if(result[i].iArticleKind==5){
			   var contents="<li><span>"+result[i].dMakeTime+"&nbsp;<a href='<%=basePath%>Article.do?method=selectEditerTheory&articleid="+result[i].sArticleId+"'>编辑</a>&nbsp;<a onclick='article_delete("+result[i].sArticleId+")' style='cursor: pointer'>删除</a></span>";
...
<script type="text/javascript">
function addArticle(){
	window.location.href="<%=basePath%>Admin/addTheoryTeaching.jsp"
}
</script>
<script type="text/javascript">
function addExcise(){
	window.location.href="<%=basePath%>Admin/addPraxis.jsp"
}
</script>
	<div class="navbg">
		<div class="col960">
...
$(document).ready(function(){
    ...
    <div style="width:1000px;position: relative;margin: 47px auto 0px;box-shadow:1px 1px 7px #999;">
        ...
        <div id="local" class="yc_location">当前位置：<a href="${pageContext.request.contextPath}/Admin/index.jsp">首页</a> &gt; <a href="#">理论教学</a> &gt; <a href="#">知识导学</a></div>
          <aside class="yc_left_box fl">
            ...
            <div class="<!-- boxImg -->"><img src="/STLVX_WEB/images/img_left_shadow_bot.png" alt="" width="206" height="180"></div>
          </aside>
          <div class="yc_right_box fl">
				<!-- <span style="margin: 30px 0 0 600px"><input  type="button" id="orderFlg" value="排序" style="width:80px;"/></span> -->
				<div id="2jtitle" class="yc_right_title0"><span style='float:left;'>知识导学</span><span style='margin: 30px 0 0 600px'><input  type='button' onclick='addArticle()' value='添加文章' style='width:80px;'/></span>
                  <div class='gradient_line'></div>
                </div>
                  <!-- <div style="float:right;display: block;height: 32px;padding: 20px 0 0 10px;color: #0083d7;z-index: 0;position: inherit;">
				     <input type="button" onclick="addArticle()" value="添加文章" />
                  </div>  -->
                  <div class="gradient_line"></div>
                  <div class="yc_right_comlist">
                    <ul id="zsdx">
                      <li><span>2016-7-22</span><a target="_blank" href="/showxxgk.aspx?Id=114523&amp;ctlgid=264622">知识导学</a></li>
                    </ul>
                    <ul id="jg" style="display:none">
                      <li><span>2016-7-22</span><a target="_blank" href="/showxxgk.aspx?Id=114523&amp;ctlgid=264622">讲稿</a></li>
                    </ul>
                    <ul id="ja" style="display:none">
                      <li><span>2016-7-22</span><a target="_blank" href="/showxxgk.aspx?Id=114523&amp;ctlgid=264622">教案</a></li>
                    </ul>
                    <ul id="kj" style="display:none">
                      <li><span>2016-7-22</span><a target="_blank" href="/showxxgk.aspx?Id=114523&amp;ctlgid=264622">课件</a><input type="button" value="下载" /></li>
                    </ul>
                    <ul id="sksp" style="display:none">
                      <li><span>2016-7-22</span><a target="_blank" href="/showxxgk.aspx?Id=114523&amp;ctlgid=264622">授课视频</a></li>
                    </ul>
                    <ul id="xt" style="display:none">
                      <li><span>2016-7-22</span><a target="_blank" href="/showxxgk.aspx?Id=114523&amp;ctlgid=264622">习题</a></li>
                    </ul>
                    <script type="text/javascript" charset="utf-8">
                        $("#zsdxt").click(function(){
                            ...
                            $("#xt").hide();
                            $("#ja").hide();
                            $("#local").html("当前位置：<a href='${pageContext.request.contextPath}/Admin/index.jsp'>首页</a> &gt; <a href='#'>理论教学</a> &gt; <a href='#'>知识导学</a>");
                            $("#2jtitle").html("<span style='float:left;'>知识导学</span>"
                                    +"<span style='margin: 30px 0 0 600px'><input  type='button' onclick='addArticle()' value='添加文章' style='width:80px;'/></span>"
                                    +"<div class='gradient_line'></div>");
                            $("#2jtitle").show();
                        })
                        $("#jgt").click(function() {
                            ...
                            $("#xt").hide();
                            $("#ja").hide();
                            $("#local").html("当前位置：<a href='${pageContext.request.contextPath}/Admin/index.jsp'>首页</a> &gt; <a href='#'>理论教学</a> &gt; <a href='#'>讲稿</a>");
                            $("#2jtitle").html("<span style='float:left;'>讲稿</span>"
                                    +"<span style='margin: 30px 0 0 600px'><input  type='button' onclick='addArticle()' value='添加文章' style='width:80px;'/></span>"
                                    +"<div class='gradient_line'></div>");
                            $("#2jtitle").show();
                        });
                        $("#kjt").click(function() {
                            ...
                            $("#xt").hide();
                            $("#ja").hide();
                            $("#local").html("当前位置：<a href='${pageContext.request.contextPath}/Admin/index.jsp'>首页</a> &gt; <a href='#'>理论教学</a> &gt; <a href='#'>课件</a>");
                            $("#2jtitle").html("<span style='float:left;'>课件</span>"
                                    +"<span style='margin: 30px 0 0 600px'><input  type='button' onclick='addArticle()' value='添加文章' style='width:80px;'/></span>"
                                    +"<div class='gradient_line'></div>");
                            $("#2jtitle").show(); 
                        ...
                        $("#skspt").click(function() {
                            ...
                            $("#xt").hide();
                            $("#ja").hide();
                            $("#local").html("当前位置：<a href='${pageContext.request.contextPath}/Admin/index.jsp'>首页</a> &gt; <a href='#'>理论教学</a> &gt; <a href='#'>授课视频</a>");
                            $("#2jtitle").html("<span style='float:left;'>授课视频</span>"
                                    +"<span style='margin: 30px 0 0 600px'><input  type='button' onclick='addArticle()' value='添加文章' style='width:80px;'/></span>"
                                    +"<div class='gradient_line'></div>");
                            $("#2jtitle").show();
                        });
                        $("#xtt").click(function() {
                            ...
                            $("#xt").show();
                            $("#ja").hide();
                            $("#local").html("当前位置：<a href='${pageContext.request.contextPath}/Admin/index.jsp'>首页</a> &gt; <a href='#'>理论教学</a> &gt; <a href='#'>习题</a>");
                            $("#2jtitle").html("<span style='float:left;'>习题</span>"
                                    +"<span style='margin: 30px 0 0 600px'><input  type='button' onclick='addExcise()' value='添加文章' style='width:80px;'/></span>"
                                    +"<div class='gradient_line'></div>");
                            $("#2jtitle").show();
                        });
                        $("#jat").click(function() {
                            ...
                            $("#xt").hide();
                            $("#ja").show();
                            $("#local").html("当前位置：<a href='${pageContext.request.contextPath}/Admin/index.jsp'>首页</a> &gt; <a href='#'>理论教学</a> &gt; <a href='#'>教案</a>");
                            $("#2jtitle").html("<span style='float:left;'>教案</span>"
                                    +"<span style='margin: 30px 0 0 600px'><input  type='button' onclick='addArticle()' value='添加文章' style='width:80px;'/></span>"
                                    +"<div class='gradient_line'></div>");
                            $("#2jtitle").show();
                        });
