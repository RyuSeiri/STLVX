...
$(document).ready(function(){
    ...
    <div style="width:1000px;position: relative;margin: 47px auto 0px;box-shadow:1px 1px 7px #999;">
       ...
       <!--  <div class="yc_location">当前位置：<a href="${pageContext.request.contextPath}/Admin/index.jsp">首页</a> &gt; <a href="#">理论教学</a> &gt; <a href="/xxgk/ggzy">讲稿</a> </div> -->
       <div class="yc_content_inner">
        <section class="showCon">
        <h1>图片详情</h1>
				 <h3><%--< span id="time">时间:${time}</span> --%>&nbsp;&nbsp;&nbsp;<font color="#ff0000">字体显示：</font>
