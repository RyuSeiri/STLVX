...
$(document).ready(function(){
	...
	<div
		...
		<!--  <div class="yc_location">当前位置：<a href="${pageContext.request.contextPath}/jsp/index.jsp">首页</a> &gt; <a href="/xxgk">理论教学</a> &gt; <a href="/xxgk/ggzy">讲稿</a> </div> -->
		<div class="yc_content_inner">
			<section class="showCon">
				<h1>图片详情</h1>
				<h3>
					<%-- <span id="time">时间:${time}</span> --%>&nbsp;&nbsp;
					<!-- 来源：XXX &nbsp; -->
					&nbsp;<font color="#ff0000">字体显示：</font> &nbsp;<span id="big"
						style="cursor: pointer">大</span> &nbsp;<span id="middle"
						style="cursor: pointer">中</span> &nbsp;<span id="small"
						style="cursor: pointer">小 </span>
					<%-- &nbsp;&nbsp;阅读：${viewtimes} 次--%>
				</h3>
				<article id="zoom">
					...
					<div>
						<span><img class="picture" src="${filepath}"></span>
					</div>
					<p class="p0">${content}</p>
              ...
              <div class="aboutList">
               <ul>
                   <li><span>2016-11-13</span><a target="_blank" title="标题标题" href="showxxgk.aspx?ctlgid=585587&amp;Id=112629">标题标题标题标题</a></li>
                   <li><span>2016-11-13</span><a target="_blank" title="标题标题标题" href="showxxgk.aspx?ctlgid=585587&amp;Id=112628">标题标题标题标题标题</a></li>
               </ul>
              </div>
