	 ...
	 //alert(req.responseText);
		...
		for(var i=0;i<result.length;i++){
			...
			if(result[i].iArticleKind==12){
			   var contents =  "<li><span>"+result[i].dMakeTime+"</span><a href='<%=basePath%>Article.do?method=selectEcProDevideoByid&articleid="+result[i].sArticleId+"'>"+result[i].sTitle+"</a></li>";
...
$(document).ready(function(){
    ...
    <div style="width:1000px;position: relative;margin: 47px auto 0px;box-shadow:1px 1px 7px #999;">
        ...
        <div id="local" class="yc_location">当前位置：<a href="${pageContext.request.contextPath}/jsp/index.jsp">首页</a> &gt; <a href="#">生态产品设计</a> &gt; <a href="#">产品设计要求</a></div>
          <aside class="yc_left_box fl">
           ...
           <script type="text/javascript" charset="utf-8">
                        $("#cpsjyqt").click(function(){
                            ...
                            $("#cpsjgc").hide();
                            $("#cpsjjg").hide();
                            $("#local").html("当前位置：<a href='${pageContext.request.contextPath}/jsp/index.jsp'>首页</a> &gt; <a href='#'>生态产品设计</a> &gt; <a href='#'>产品设计要求</a>");
                            $("#2jtitle").html("<span>产品设计要求</span>");
                            $(".pagebox").hide();
                            $("#2jtitle").hide();
                        })
                        $("#cpsjgct").click(function() {
                            ...
                            $("#cpsjgc").show();
                            $("#cpsjjg").hide();
                            $("#local").html("当前位置：<a href='${pageContext.request.contextPath}/jsp/index.jsp'>首页</a> &gt; <a href='#'>生态产品设计</a> &gt; <a href='#'>产品设计过程</a>");
                            $("#2jtitle").html("<span>产品设计过程</span>");
                            $(".pagebox").show();
                            $("#2jtitle").show();
                        });
                        $("#cpsjjgt").click(function() {
                            ...
                            $("#cpsjgc").hide();
                            $("#cpsjjg").show();
                            $("#local").html("当前位置：<a href='${pageContext.request.contextPath}/jsp/index.jsp'>首页</a> &gt; <a href='#'>生态产品设计</a> &gt; <a href='#'>产品设计结果</a>");
                            $("#2jtitle").html("<span>产品设计结果</span>");
                            $(".pagebox").show();
                            $("#2jtitle").show();
                        });
