...
function createAjaxObj() {
	...
	req.open("post", "<%=basePath%>Article.do?method=selectActicleByKind&kind=2");
...
<body style="background:url(../images/bg_sea.jpg) no-repeat center top" onload="index_show()">
...
$(document).ready(function(){
	...
	<div style="width: 1000px; position: relative; margin: 47px auto 0px; box-shadow: 1px 1px 7px #999;">
		...
		<!--  <div class="yc_location">当前位置：<a href="${pageContext.request.contextPath}/Admin/index.jsp">首页</a> &gt; <a href="#">理论教学</a> &gt; <a href="#">讲稿</a> </div> -->
