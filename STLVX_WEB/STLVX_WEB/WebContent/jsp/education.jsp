	 ...
	 //alert(req.responseText);
		...
		for(var i=0;i<result.length;i++){
			if(result[i].iArticleKind==15){
			   var contents =  "<li><span>"+result[i].dMakeTime+"</span><a href='<%=basePath%>Article.do?method=selectEducationProgram&articleid="+result[i].sArticleId+"'>"+result[i].sTitle+"</a></li>";
...
$(document).ready(function(){
    ...
    <div style="width:1000px;position: relative;margin: 47px auto 0px;box-shadow:1px 1px 7px #999;">
        ...
        <div id="local" class="yc_location">当前位置：<a href="${pageContext.request.contextPath}/jsp/index.jsp">首页</a> &gt; <a href="#">环境教育</a> &gt; <a href="#">环境教育大纲</a></div>
          ...
          <aside class="yc_left_box fl">
           ...
           $("#cpsjgct").click(function() {
               $("#cpsjgc").show();
               $("#cpsjjg").hide();
               $("#local").html("当前位置：<a href='${pageContext.request.contextPath}/jsp/index.jsp'>首页</a> &gt; <a href='#'>环境教育</a> &gt; <a href='#'>环境教育大纲</a>");
               $("#2jtitle").html("<span>环境教育大纲</span>");
               $(".pagebox").show();
           });
           $("#cpsjjgt").click(function() {
               $("#cpsjgc").hide();
               $("#cpsjjg").show();
               $("#local").html("当前位置：<a href='${pageContext.request.contextPath}/jsp/index.jsp'>首页</a> &gt; <a href='#'>环境教育</a> &gt; <a href='#'>环境教育效果</a>");
               $("#2jtitle").html("<span>环境教育效果</span>");
               $(".pagebox").show();
           });
          </script>
