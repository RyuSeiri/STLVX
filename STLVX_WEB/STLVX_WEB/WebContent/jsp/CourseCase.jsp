...
$(document).ready(function(){
    ...
    <div style="width:1000px;position: relative;margin: 47px auto 0px;box-shadow:1px 1px 7px #999;">
      ...
      <div class="yc_location">当前位置：<a href="${pageContext.request.contextPath}/jsp/index.jsp">首页</a> &gt; <a href="${pageContext.request.contextPath}/jsp/CourseCase.jsp">课程案例</a><!--  &gt; <a href="#">讲稿</a> --></div>
