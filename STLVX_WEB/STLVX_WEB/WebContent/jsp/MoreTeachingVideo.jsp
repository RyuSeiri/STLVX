...
$(document).ready(function(){
    ...
    <div style="width:1000px;position: relative;margin: 47px auto 0px;box-shadow:1px 1px 7px #999;">
        ...
        <div id="local" class="yc_location">当前位置：<a href="${pageContext.request.contextPath}/jsp/index.jsp">首页</a> &gt; <a href="${pageContext.request.contextPath}/jsp/TheoryTeaching.jsp">理论教学</a> &gt; <a href="#">更多授课视频</a></div>
