...
<div class = "caroursel poster-main" data-setting = '{
	       ...
	       <div id="posterlist"> 
	         <ul class = "poster-list" >
	            <li class = "poster-item"><img id="top_img2" src="" width = "100%" height="100%"></li>
	            <li class = "poster-item"><img id="top_img3" src="" width = "100%" height="100%"></li>
	            <li class = "poster-item"><img id="top_img4" src="" width = "100%" height="100%"></li>
	            <li class = "poster-item"><img id="top_img5" src="" width = "100%" height="100%"></li>
	            <li class = "poster-item"><img id="top_img6" src=""  width = "100%" height="100%"></li>
	            <li class = "poster-item"><img id="top_img1" src=""  width = "100%" height="100%"></li>
	            <li class = "poster-item"><img id="top_img7" src=""  width = "100%" height="100%"></li>
	        </ul>
	        </div>
    ...
    <div style="width:1000px;position: relative;margin: 0 auto 0px;box-shadow:1px 1px 7px #999;">
	    <div style="width:950px;position: relative;margin: 0 auto -30px;">
		    <div class="title">
		    	<div class="titlepic"><img src="/STLVX_WEB/images/hua_icon.png"></div>
		        <h6>理论教学</h6>
		        <a href="#"><img src="/STLVX_WEB/images/img-07.jpg"></a>
		    </div>
		    <div style="position: relative;margin:40px auto 0;width:950px;height: 140px;" id="index_lljxList">
		    <!-- <ul class="content">
		    	<li>
				    <ul>
	    ...
	    <div style="width:950px;position: relative;margin: 0 auto -30px;">
		    <div class="title">
		    	<div class="titlepic"><img src="/STLVX_WEB/images/img-46.png"></div>
		        <h6>授课视频</h6>
		        <a href="#"><img src="/STLVX_WEB/images/img-07.jpg"></a>
		    </div>
		    <div style="position: relative;margin:40px auto 0;width:950px;height: 140px;" id="index_skspList">
		    <!-- <ul class="content">
		    	<li>
				    <ul>
				    	<li><a>理论教学</a><span>11-07</span></li>
	    ...
	    <div style="width:950px;position: relative;margin: 0 auto -30px;">
		    ...
		    <div style="position: relative;margin:40px auto 0;width:950px;height: 190px;" id="index_kcalList">
                 <!--  <div class="dqinfo">
		              <div class="withpic"> 
		              	<div class="pic"><a href="#"><img src=""></a></div>
		                <div class="text">
		                <h3><a target="_blank" href="#"><span class="hua">案例</span>简介</a></h3>
		              ...
		              <div class="withpic"> 
		              	<div class="pic"><a href="#"><img src=""></a></div>
		              	<div class="text">
		                <h3><a target="_blank" href="#"><span>案例</span>简介</a></h3>
		                <p>简介简介简介简介简介简介简介简介简介简介简介简介简介简介简介简介简介</p>
		                </div>
		              </div> 
            	  </div>
                  <div class="dqinfo" style="margin-left:300px;">
		              <div class="withpic"> 
		              	<div class="pic"><a href="#"><img src=""></a></div>
		              	<div class="text">
		                <h3><a target="_blank" href="#" class="red"><span class="hua">案例</span>简介</a></h3>
		                <p>简介简介简介简介简介简介简介简介简介简介简介简介简介简介简介简介简介</p>
		                </div>
		              </div>
		              <div class="withpic"> 
	    ...
	    <div style="width:950px;position: relative;margin: 0 auto -30px;">
		    <div class="title">
		    	<div class="titlepic"><img src="/STLVX_WEB/images/tu_icon.png"></div>
		        <h6>图片库</h6>
		        <a href="#"><img src="/STLVX_WEB/images/img-07.jpg"></a>
		    </div>
		    <div style="position: relative;margin:40px auto 0;width:950px;height: 150px;padding-top:10px;">
                  <div class="dq_picture_box">
		          <div class="yc_studio_slider">
		            <div id="slider" >
		              <ul>
		                <li><img src="" alt="" width="212" height="159"/><a target="_blank" href="" class="img_mark nodis">图片</a></li>
		                <li><img src="" alt="" width="212" height="159"/><a target="_blank" href="" class="img_mark nodis">图片</a></li>
		                <li><img src="" alt="" width="212" height="159"/><a target="_blank" href="" class="img_mark nodis">图片</a></li>
		                <li><img src="" alt="" width="212" height="159"/><a target="_blank" href="" class="img_mark nodis">图片</a></li>
		                <li><img src="" alt="" width="212" height="159"/><a target="_blank" href="" class="img_mark nodis">图片</a></li>
    	...
    	<div style="width:950px;position: relative;margin: 0 auto 15px;">
		    ...
		    <div style="position: relative;margin:40px auto 0;width:950px;height: 190px;" id="index_kzxxList">
                 <!--  <div class="dqinfo">
		              <div class="withpic"> 
		              	<div class="pic"><a href="#"><img src=""></a></div>
		                <div class="text">
