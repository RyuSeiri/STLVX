	...
	if (req.readyState == 4 && req.status == 200) {
	  //alert(req.responseText);
		...
		for(var i=0;i<result.length;i++){
			  contents += "<li><span>"+result[i].dMakeTime+"</span><a href='<%=basePath%>Article.do?method=selectExercises&articleid="+result[i].sArticleId+"'>"+result[i].sTitle+"</a></li>";
			}
...
function selectChapterArticle(chapter){
	...
	req.onreadystatechange = function() {
		if (req.readyState == 4 && req.status == 200) {
		 ...
		 $("#local").html("当前位置：<a href='index.jsp'>首页</a> &gt; <a href='#'>习题</a> &gt; <a href='#'>第"+chapter+"章</a>");
	}
	req.send(null);
}
</script>
	...
	<div
		...
		<div class="yc_content_inner">
			...
			<div id="local" class="yc_location">
				...
				&gt; <a href="#">习题</a> &gt; <a href="#" id="cp">第1章</a>
			</div>
		...
		<div class="yc_right_comlist">
			<ul id="cpsjgc">
				<li><span>2016-7-22</span><a target="_blank"
					href="/showxxgk.aspx?Id=114523&amp;ctlgid=264622">啦啦啦</a></li>
			</ul>
		...
		<div class="pagebox" style="display: none;">
			<span style="line-height: 22px;">&nbsp;共有24条记录，当前第<b>1</b>/2页&nbsp;&nbsp;&nbsp;
			</span><span class="pagebox_pre"><a href="index.html">第一页</a></span><span
				class="pagebox_pre"><a href="javascript:void(0);">上一页</a></span><span
				class="pagebox_num_nonce">1</span><span class="pagebox_num"><a
				href="/xxgklist.aspx?p=2&amp;ctlgid=264622" target="_self">2</a></span><span
				class="pagebox_next"><a
				href="/xxgklist.aspx?p=2&amp;ctlgid=264622" target="_self">下一页</a></span><span
				class="pagebox_next"><a
				href="/xxgklist.aspx?p=2&amp;ctlgid=264622">最末页</a></span>
		</div>
		<!--pagebox-->
