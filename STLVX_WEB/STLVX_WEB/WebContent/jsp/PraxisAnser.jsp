...
<body style="background:url(/STLVX_WEB/images/bg_sea.jpg) no-repeat center top" onload="index_show()">
 	...
 	<div class="navbg">
		<div class="col960">
			<ul id="navul" class="cl">
				...
				<li>
					<a href="${pageContext.request.contextPath}/jsp/">在线测试</a>
				</li>
				<li>
					<a href="${pageContext.request.contextPath}/jsp/extensionTeaching.jsp">扩展学习</a>
				</li>
				<li>
					<a href="${pageContext.request.contextPath}/jsp/">互动教学</a>
				</li>
			</ul>
		</div>
	</div>
	...
	<div style="width: 1000px; position: relative; margin: 47px auto 0px; box-shadow: 1px 1px 7px #999;">
		...
		<div class="yc_content_inner">
			<section class="showCon">
	          ...
	          <h3><span id="time">时间：${result[0].dMakeTime}</span>&nbsp;&nbsp;&nbsp;&nbsp;<font color="#ff0000">字体显示：</font>
				...
				<article id="zoom">
					...
					<p class="p0">
					<%-- ${result[0].praxisInfo} --%>
					<!--如果习题表中有数据用它没有就用文章表中的数据  -->
                      ${result[0].sContent}
					</p>
					<br/><br/><div id="show" >显示答案&nbsp;&nbsp;<span style="cursor: pointer">[+]</span></div>
				</article>
				<article>
				<p class="p0" style="display: none;" id="answer">
                       ${null!=result[0].answerInfo?result[0].answerInfo:"该习题暂时没有参考答案"}
				</p>
				</article>
          ...
          $("#show").toggle(
	      function () {
	    	  $("#show").html("收起答案 &nbsp;&nbsp;<span style='cursor: pointer'>[-]</span>");
	    	  $("#answer").fadeIn("slow"); 
	      },
	      function () {
	    	  $("#show").html("显示答案&nbsp;&nbsp;<span style='cursor: pointer'>[+]</span>");
	    	  $("#answer").fadeOut("slow");
	      });
               </script>
				<!-- <div class="aboutLink">
