...
function createAjaxObj() {
	...
	req.open("post", "<%=basePath%>Article.do?method=selcetEnviroEducation&kind=15");
	...
	req.onreadystatechange = function() {
		if (req.readyState == 4 && req.status == 200) {
			...
			var contents =  "<p align='center' style='text-align: center'><b style='font-size: 30px' style='font-weight:bold'>";
				...
				/* if(null!=result[i].filetype&&result[i].filetype!=0){
				contents =contents+"<div><span><img class='picture' src='"+result[i].filepath+"'";
				}else{
				contents =contents+"<div><span><img class='picture' src='/STLVX_WEB/images/pictureNotFound.jpg'";
				} */
				contents =contents+"</span></div>";
				contents = contents + "<p class='p0'>"+result[i].sContent+"</p>";
				$('#zoom').html(contents);
