...
<body onload="init()">
	...
	<div id="computer"
		...
		<div>
			<div>
				<h1 class="font">500</h1>
			</div>
			<div class="norsTitle">很抱歉，您要访问的页面正在维护中请稍后在进行访问！</div>
	...
	<div id="mobile" style="display: none;">
		<div class="top">
			<br /> <br /> <br /> <br /> <br />
			<h1 class="mobilefont">500</h1>
		</div>
		<div>
			<br /> <br /> <br /> <br /> <br />
			<p class="mobileNorsTitle">很抱歉，您要访问的页面正在维护中请稍后在进行访问！</p>
